...
%% Thrust Stuff
Dprop = 12 * 0.0254 % Propeller diameter [m] (12 i in m)
rprop = Dprop/2 % Propeller radius [m]
A = pi * rprop^2 % Area of the propeller disk [m^2]

thrust_max = 2300/1000 % Max Thrust [N]

ve = sqrt(2 * thrust_max / (rho * A)) % Exit velocity [m/s]
